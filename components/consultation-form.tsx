              ...
              <CardContent>
                <Accordion type="multiple" defaultValue={["chief-complaint"]} className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            {isRecording ? "Stop" : "Start"} AI Dictation
                          </Button>
                        </div>
                        {isRecording && (
                          <div className="text-sm text-primary flex items-center gap-2">
                            <div className="w-2 h-2 bg-red-500 rounded-full animate-pulse"></div>
                            AI is listening... Speak your findings clearly
                          </div>
                        )}
                      </div>
                    </AccordionContent>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                          <div>
                            ...
                            <Textarea
                              id="extra-oral"
                              placeholder="Facial symmetry, lymph nodes, TMJ examination, muscle palpation, skin changes..."
                          ...
                          <div>
                            ...
                            <Textarea
                              id="intra-oral"
                              placeholder="Soft tissues, hard tissues, tooth-specific findings, oral hygiene..."
                              className="mt-1 min-h-[100px]"
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <Textarea
                              id="periodontal"
                              placeholder="Gingival condition, pocket depths, mobility, bleeding on probing..."
                              className="mt-1 min-h-[100px]"
                          ...
                          <div>
                            ...
                            <Textarea
                              id="occlusion"
                              placeholder="Bite relationship, interferences, wear patterns, jaw movements..."
                              className="mt-1 min-h-[100px]"
                  ...
                  <AccordionItem value="investigations" className="border rounded-lg px-4">
                    <AccordionTrigger className="text-lg font-medium text-primary hover:no-underline">
                      Other Investigations (X-rays, Lab, Tests)
                    </AccordionTrigger>
                    <AccordionContent className="space-y-6 pt-4">
                      <div className="space-y-4">
                        <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <Textarea
                              ...
                              placeholder="Blood tests, biopsy, bacterial culture, special tests..."
                              className="mt-1"
